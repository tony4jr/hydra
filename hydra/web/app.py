...
# Phase 4 Slice 4.1a — web terminal. terminal.router 가 /admin/* + /workers/*
# 둘 다 가지고 있어서 prefix=/api 만 부여. admin 부분은 모듈 내부에서
# admin_session Depends 로 자체 가드 (라우터 단위 _ADMIN_DEPS 적용 안 함).
