...
from hydra.web.routes import accounts, brands, campaigns, dashboard, keywords, videos, settings, pools, logs, system, export, creator, recovery, campaign_videos, niches, tags, admin_feed, comment_presets
...
app.include_router(niches.router, prefix="/api/admin/niches", tags=["admin-niches"], dependencies=_ADMIN_DEPS)
app.include_router(tags.router, prefix="/api/admin/tags", tags=["admin-tags"], dependencies=_ADMIN_DEPS)
...
app.include_router(admin_video_pool.router, prefix="/api/admin/video-pool",
                   tags=["admin-video-pool"], dependencies=_ADMIN_DEPS)
app.include_router(admin_pipeline.router, tags=["admin-pipeline"], dependencies=_ADMIN_DEPS)
